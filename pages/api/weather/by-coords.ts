...
// Clé API OpenWeatherMap et URL de base
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  // Vérifier que lat et lon sont présents et non des tableaux
  ...
  try {
    ...
    // Retourner les informations météo formatées au front-end
    res.status(200).json({
      name: data.name,                     
